(ns DiscriminatorTrial.core
  (:require 
    :require clojure.contrib.math
    [clojure.zip :as zip]
;   :dependencies [[local-file "0.0.4"]]
    ))

"This is a copy of Lee Spector's code that will be used initially to find a b-1 discriminator"
...
;(evolve-term discriminator-errors b1 100000 1000 50 20)

;(evolve-term malcev-errors a1 100000 1000 50 20)

;;
;(evolve-term malcev-errors a1 1000 1000 50 20)
...
(evolve-term discriminator-errors b1 10 10 10 10)
